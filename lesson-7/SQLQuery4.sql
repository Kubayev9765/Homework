...
--	first_name,
--	salary,
--	iif(salary<9000, 'low salary', 'hight salary') as res_salary,
--	iif(salary<9000, 'Low salary', 
--							iif(salary<13000, 'Medium','Higt salary') 		
--		) res_salary_2
--from employees
...
--	CUST_CITY, 
--	WORKING_AREA,
--	iif(CUST_CITY=WORKING_AREA, 'Yes', 'No') as Cus_result,
--	case
--		when working_area like '% %'
--		then 'Yes'
--		else 'No'
--	end as Cus_result_2
--from CUSTOMER
